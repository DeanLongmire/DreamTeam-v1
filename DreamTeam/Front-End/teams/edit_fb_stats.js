...
let TDs = document.getElementById("touchdowns");
...
let buttonSubmit = function(callback) {
    ...
    if(catches.value != "")
    {
        newCatches = parseInt(catches.value);
    }
    else
    {
        newCatches = undefined;
    }
    if(tackles.value != "")
    {
       newTackles = parseInt(tackles.value);
    }
    else
    {
        newTackles = undefined;
    }
